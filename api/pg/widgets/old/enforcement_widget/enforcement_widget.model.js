...
//     ]).then(([ currency, jobPositionAssignAndPredictions, atvChart, issuanceCN, towedChart, clampedChart, eoGapChart, towTruckGapChart ]) => {
//         return { currency, ...jobPositionAssignAndPredictions, atvChart, issuanceCN, towedChart, clampedChart, eoGapChart, towTruckGapChart }
//     });
// };
...
//     let query = "select sum(amount) as amount from " + CONTRAVENTION + " ";
//     query += "where project_id = $2 ";
